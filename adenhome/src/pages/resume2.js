  ...
  return (
    <div className="w-full">
      ...
      <div className="resume-page w-full max-w-3xl mx-auto p-8 bg-gray-100">
        <div className="bg-white shadow-lg rounded-xl p-8 space-y-8 cover-page">
          <header className="space-y-2">
            <h1 className="text-3xl font-bold text-gray-900">Aden Power</h1>
          ...
          <CoverSection title="Profile">
            <p className="text-sm text-gray-700">
              I'm a machine learning and AI researcher, specialising in technical questions about the ever-advancing frontier of AI. 
              <br></br>
              The technical research I do is guided by my perspective of AI as rapidly advancing highly transformative technology, in particular:
            </p>
            <ul className="list-disc ml-6 text-sm space-y-1 text-gray-700">

              <li>How can emerging AI technologies be used for good?</li>
              <li>What kind of governance and innovation is needed to advance AI technology in a safe and strategic manner and minimise the risk of societal harm?</li>
              <li>What role does AI technology have in strengthening Australian sovereignty? </li>
            </ul>
          </CoverSection>

          <CoverSection title="Pedagogy">
            <p className="text-sm text-gray-700">
              My academic background is in mathematics where clear communication of advanced technical concepts both within and across displicines is imperative for advancing the field.

              <br></br>

              <br></br>

              I have over six years professional experience as a teacher, tutor and instructor for diverse audiences and formats. 
              I have taught mathematics at levels ranging from disadvantaged  primary students children university students and competition participants. I have developed my own materials and curricula to suit the composition of the student bodies.

              <br></br>
              <br></br>

              I have extensive public speaking experience including giving a host of lectures during my university studies to audiences ranging from completely non-technical to highly technical. I also have experience running interactive workshops for audiences of approximately 60 people.

              <br></br>
              <br></br>

              I have also been contracted to write the curriculum for a course informing Australian business owners about modern AI technologies and how they can be applied to their use cases.
            </p>
          </CoverSection>
...
function CoverSection({ title, children }) {
  return (
